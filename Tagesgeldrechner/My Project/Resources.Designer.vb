...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Sucht eine lokalisierte Zeichenfolge, die Es läuft bereits eine Instanz dieser Anwendung! ähnelt.
        '''</summary>
        Friend ReadOnly Property StartupNextInstanceString() As String
            Get
                Return ResourceManager.GetString("StartupNextInstanceString", resourceCulture)
            End Get
        End Property
    End Module
End Namespace
